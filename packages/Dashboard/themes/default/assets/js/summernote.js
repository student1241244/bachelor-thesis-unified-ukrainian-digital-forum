  ...
  */
  ...
  var Editor = function (context) {
    ...
    var afterCommand = this.afterCommand = function (isPreventTrigger) {
      history.recordUndo($editable.html());
      if (!isPreventTrigger) {
        context.triggerEvent('change', $editable.html());
      }
    };
  ...
  var Clipboard = function (context) {
    ...
    this.pasteByEvent = function (event) {
      ...
      if (clipboardData && clipboardData.items && clipboardData.items.length) {
        ...
        if('clearAttributesBeforeCopy' in context.options.extensions){
          setTimeout(function () {
            context.code(context.options.extensions['clearAttributesBeforeCopy']($editable.html()));
  ...
  var TablePopover = function (context) {
    ...
    this.initialize = function () {
      ...
      if (agent.isFF) {
        document.execCommand('enableInlineTableРедагування', false, false);
      }
    };

    ...
    <section class="hero-area bg-white shadow-sm overflow-hidden">
        ...
        <div class="container">
            <div class="hero-content pt-80px pb-80px">
                <h2 class="section-title">Створіть нову тему</h2>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card card-item">
                        <form method="post" class="card-body" id="thread-form" action="{{ route('threads.store') }}">
                            @csrf
                            <div class="input-box">
                                <label class="fs-14 text-black fw-medium mb-0">Назва</label>
                                <p class="fs-13 pb-3 lh-20">Будьте конкретними та уявіть, що ви ставите запитання іншій людині</p>
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="title" placeholder="наприклад: Тред про Авто">
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                                <label class="fs-14 text-black fw-medium mb-0">Категорія</label>
                                <p class="fs-13 pb-3 lh-20">Будь ласка, виберіть відповідний розділ, щоб запитання можна було легко знайти.</p>
                                <div class="form-group">
                            ...
                            <div class="input-box">
                                <label class="fs-14 text-black fw-medium mb-0">Тіло питання</label>
                                <p class="fs-13 pb-3 lh-20">Включіть усю інформацію, яка потрібна комусь, щоб відповісти на ваше запитання</p>
                                <div class="form-group">
                                    <textarea class="form-control form--control user-text-editor" name="body" rows="10" cols="40"></textarea>
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                                <label class="fs-14 text-black fw-medium">Зображення (Максимум 1 зображення. Не більше 2048 КБ)</label>
                                <div class="form-group">
                            ...
                            <div class="input-box pt-2">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox fs-13">
                                        ...
                                        <label class="custom-control-label custom--control-label" for="is_agree">Ставлячи своє запитання, ви погоджуєтеся з <a href="/content-policy" class="text-color hover-underline">Політикою контенту.</a></label>
                                    </div>
                                </div>
                                <div class="btn-box">
                                    <button type="submit" class="btn theme-btn">Опублікуйте свою тему</button>
                                </div>
                            </div>
                        </form>
                    </div><!-- end card -->

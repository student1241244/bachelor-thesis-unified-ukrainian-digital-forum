    ...
    <section class="hero-area bg-white shadow-sm overflow-hidden">
        ...
        <div class="container">
            <div class="hero-content pt-80px pb-80px">
                <h2 class="section-title">Create a new thread</h2>
                ...
                <div class="col-lg-8">
                    <div class="card card-item">
                        <form method="post" class="card-body" id="thread-form" action="{{ route('threads.store') }}">
                            ...
                            <div class="input-box">
                                <label class="fs-14 text-black fw-medium mb-0">Body</label>
                            ...
                            <div class="input-box pt-2">
                                ...
                                <div class="btn-box">
                                    <button type="submit" class="btn theme-btn">Publish your thread</button>
                                </div>
                            </div>
                        </form>
                    </div><!-- end card -->

                ...
                <div class="logo-box">
                    ...
                    <div class="user-action">
                        <div class="search-menu-toggle icon-element icon-element-xs shadow-sm mr-1" data-toggle="tooltip" data-placement="top" title="Search">
                            <a href="#" class="text-white mr-2 header-search-icon" style="top:0px;padding:10px 10px;color:black!important;"><i class="la la-search"></a></i>
                        </div>
                ...
                <div class="menu-wrapper border-left border-left-gray pl-4 justify-content-end">
                    ...
                    <form class="mr-2">
                        <div class="form-group mb-0">
                            <a href="#" class="text-white mr-2 header-search-icon2" title="Search" data-toggle="tooltip" data-placement="bottom">Type your search words... <i class="la la-search"></i></a>
                        </div>
                    </form>
                    @auth

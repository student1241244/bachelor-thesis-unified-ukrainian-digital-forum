...
<header class="header-area bg-dark">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-2">
                <div class="logo-box">
                    <a href="/" class="logo"><img src="/images/logo-white.png" alt="logo"></a>
            ...
            <div class="col-lg-10">
                <div class="menu-wrapper">
                    ...
                    @else
                    <div class="nav-right-button">
                        <a href="/signin" class="btn theme-btn theme-btn-outline theme-btn-outline-white mr-2"><i class="la la-sign-in mr-1"></i> Логін</a>
                        <a href="/signup" class="btn theme-btn theme-btn-white"><i class="la la-user mr-1"></i> Зареєструватися</a>
                    </div><!-- end nav-right-button -->
                    @endauth

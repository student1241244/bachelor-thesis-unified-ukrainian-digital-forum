...
<section class="hero-area bg-white shadow-sm overflow-hidden">
    ...
    <div class="container">
        <div class="hero-content pt-80px pb-80px">
            <h2 class="section-title">Задайте публічне запитання</h2>
            ...
            <div class="col-lg-8">
                <div class="card card-item">
                    <form action="{{ route('question.create') }}" method="post" class="card-body" enctype="multipart/form-data">
                        @csrf
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Назва питання</label>
                            <p class="fs-13 pb-3 lh-20">Будьте конкретними та уявіть, що ви ставите запитання іншій людині</p>
                            <div class="form-group">
                                <input value="{{old('title')}}" class="form-control form--control" type="text" name="title" placeholder="напр. Чи існує функція R для знаходження індексу елемента у векторі?">
                                @error('title')
                        ...
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Подробиці</label>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <div class="file-upload-wrap file-upload-layout-2">
                                    ...
                                    <span class="file-upload-text d-flex align-items-center justify-content-center"><i class="la la-cloud-upload mr-2 fs-24"></i>Перетягніть файли сюди або натисніть, щоб завантажити.</span>
                                </div>
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box pt-2">
                            ...
                            <div class="btn-box">
                                <button type="submit" class="btn theme-btn">Опублікуйте своє запитання</button>
                            </div>
                        </div>
                    </form>
                </div><!-- end card -->

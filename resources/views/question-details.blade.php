            ...
            <div class="col-lg-9">
                <div class="question-main-bar mb-50px">
                    ...
                    <div class="question d-flex">
                        <span id="vote-count">{{ $question->votes_count }}</span>
                        <button onclick="voteQuestion({{$question->id}}, 1)">Upvote</button>
                        <button onclick="voteQuestion({{$question->id}}, -1)">Downvote</button>
                                    ...
                                    @else
                                        ...
                                        @foreach ($comments as $comment)
                                            <div class="comment">
                                                ...
                                                <small>Posted by: {{ $comment->user->username }} on {{ $comment->created_at->format('n/j/Y H:i') }}</small>
...
<code>&lt;button
 ...
 <span class="code-attr">data-productId</span>=
                            ...
                            <div class="comments-wrap">
                                <ul class="comments-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="comment-body">
                                            <span class="comment-copy">Your are missing quotes <code class="code">data-productId=</code> Your markup breaks after that</span>
                                            <span class="comment-separated">-</span>
                                ...
                                <div class="comment-form">
                                    ...
                                    <div class="collapse border-top border-top-gray mt-2 pt-3" id="addCommentCollapse">
                                        <form action="/question-details/{{$question->id}}/create-comment" method="POST" class="row pb-3">
                                            @csrf
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea class="form-control form--control form-control-sm fs-13" name="body" rows="5" placeholder="Your comment here..."></textarea>

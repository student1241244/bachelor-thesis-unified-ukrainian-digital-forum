            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="user-panel-main-bar">
                                ...
                                <div class="user-panel mb-30px pt-30px border-top border-top-gray">
                                    <ul class="generic-list-item generic-list-item-bullet">
                                        {{$sharedData['questionCount']}}
                                        @foreach($questions as $question)
                                        <li class="pl-3"><a href="/question-details/{{$question->id}}" class="d-inline-block">{{$question->title}}. Created: {{$question->created_at->format('n/j/Y')}}</a></li>
                                        @endforeach
                                    </ul>
                                </div><!-- end user-panel -->
                                ...
                                <div>
                                    <a href="/profile/{{$follow->userDoingTheFollowing->username}}"><img src="{{$follow->userDoingTheFollowing->avatar}}"></a>
                                ...
                                <div>
                                    <a href="/profile/{{$follow->userBeingFollowed->username}}"><img src="{{$follow->userBeingFollowed->avatar}}"></a>
                            ...
                            <div class="user-panel-main-bar">
                                <div class="user-panel mb-40px">
                                    ...
                                    <div class="media media-card align-items-center shadow-none border border-gray p-3 text-center">
                                        <div class="media-body">
                                            <h5 class="fw-medium">224,110 {{$sharedData['username']}}</h5>
                        ...
                        <div class="tab-pane fade" id="user-questions" role="tabpanel" aria-labelledby="user-questions-tab">
                            @if ($questions->count())

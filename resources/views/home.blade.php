            ...
            <div class="col-lg-6 mr-auto">
                <div class="hero-content">
                    ...
                    <div class="hero-btn-box pt-30px">
                        <a href="#for-sections" class="btn theme-btn mr-2 page-scroll">Questions & Answers <i class="la la-angle-down icon ml-1"></i></a>
                        <a href="#for-sections" class="btn theme-btn bg-3 page-scroll">Forum Threads <i class="la la-angle-down icon ml-1"></i></a>
                    </div>
                ...
                <div class="col responsive-column-half border-right border-right-gray">
                    <div class="media media-card text-center px-0 py-4 shadow-none rounded-0 bg-transparent counter-item mb-0">
                        <div class="media-body">
                            ...
                            <p class="lh-20">Answers provided</p>
                        </div>
                    </div>
                </div><!-- end col -->
                <div class="col responsive-column-half border-right border-right-gray">
            ...
            <div class="col-lg-4-1 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Questions & Answers</h5>
                        <p class="card-text pb-4">The goal of this section is to provide a definitive answer to a specific question, with discussion serving the purpose of arriving at the correct response across 4 different categories</p>
                        <a href="/qa-home" class="btn theme-btn">Browse questions <i class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4-1 responsive-column-half">
        ...
        <div class="row pt-50px">
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a>Q&A</a></h5>
                        <p>Engage with the Ukrainian community through Q&A section, enabling a free exchange of knowledge and finding answers to your questions</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a>Community engagement</a></h5>
                        <p>Connect and collaborate with fellow Ukrainians, enhancing cultural and social bonds within the forum's safe space</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a>Content discovery</a></h5>
                        <p>Discover and dive into rich, diverse discussions that shape and reflect the Ukrainian experience and ethos</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
        ...
        <div class="row pt-60px align-items-center">
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Forum leaders</h5>
                    <p class="card-text">Guide the platform's growth and foster a welcoming environment for all users</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Cultural ambassadors</h5>
                    <p class="card-text">Individuals who promote the use of the Ukrainian language on the platform and help to maintain a culturally rich and respectful online environment</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center case-card-is-active">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Content contributors</h5>
                    <p class="card-text">Share insights, experiences, and knowledge within the Ukrainian community</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Only Ukrainian language</h5>
                    <p class="card-text">This is a perfect time to move to Ukrainian, with like-minded people like you</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Knowledge seekers</h5>
                    <p class="card-text">Enthusiastic learners who utilize the platform's Q&A section to ask questions, seek advice, and gain insights from the shared experiences of the community</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
        </div><!-- end row -->
    </div><!-- end container -->
...
<section class="get-started-area section--padding">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title">Learn and grow with Lemyk</h2>
        </div>
        <div class="row pt-50px">
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Engage in dynamic discussions</h3>
                        <p>Dive into diverse topics and craft the narrative of your community's future through active participation in forum threads.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Contribute to Collective Wisdom</h3>
                        <p>Share your expertise or seek advice in our inclusive Q&A space, where every question and answer enriches our shared knowledge pool.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Explore cultural insights</h3>
                        <p>Discover the richness of Ukrainian culture through shared stories, experiences, and discussions that resonate with your heritage and interests.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Connect with Like-minded Individuals</h3>
                        <p>Find and engage with peers who share your passion for topics that matter, fostering a sense of belonging and community spirit.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->

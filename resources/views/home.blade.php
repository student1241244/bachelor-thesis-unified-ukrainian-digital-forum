        ...
        <div class="row">
            <div class="col-lg-6 mr-auto">
                ...
                <div class="hero-content">
                    <h2 class="section-title fs-50 pb-3 text-white lh-65">Приєднуйтесь до першого українського форуму з розбудови громад!</h2>
                    <p class="lh-26 text-white">Ми раді, що ви до нас прийшли, давайте разом будувати українську громаду</p>
                    <div class="hero-btn-box pt-30px">
                        <a href="#for-sections" class="btn theme-btn mr-2 page-scroll">Питання та відповіді <i class="la la-angle-down icon ml-1"></i></a>
                        <a href="#for-sections" class="btn theme-btn bg-3 page-scroll">Треди <i class="la la-angle-down icon ml-1"></i></a>
                    </div>
                ...
                <div class="col responsive-column-half border-right border-right-gray">
                    <div class="media media-card text-center px-0 py-4 shadow-none rounded-0 bg-transparent counter-item mb-0">
                        <div class="media-body">
                            ...
                            <p class="lh-20">Загальна кількість користувачів</p>
                        </div>
                    </div>
                </div><!-- end col -->
                <div class="col responsive-column-half border-right border-right-gray">
                    <div class="media media-card text-center px-0 py-4 shadow-none rounded-0 bg-transparent counter-item mb-0">
                        <div class="media-body">
                            ...
                            <p class="lh-20">Питання, задані на сьогоднішній день</p>
                        </div>
                    </div>
                </div><!-- end col -->
                <div class="col responsive-column-half border-right border-right-gray">
                    <div class="media media-card text-center px-0 py-4 shadow-none rounded-0 bg-transparent counter-item mb-0">
                        <div class="media-body">
                            ...
                            <p class="lh-20">Відповіді надані</p>
                        </div>
                    </div>
                </div><!-- end col -->
                <div class="col responsive-column-half border-right border-right-gray">
                    <div class="media media-card text-center px-0 py-4 shadow-none rounded-0 bg-transparent counter-item mb-0">
                        <div class="media-body">
                            ...
                            <p class="lh-20">Теми, створені на сьогоднішній день</p>
                        </div>
                    </div>
                </div><!-- end col -->
                <div class="col responsive-column-half">
                    <div class="media media-card text-center px-0 py-4 shadow-none rounded-0 bg-transparent counter-item mb-0">
                        <div class="media-body">
                            ...
                            <p class="lh-20">Коментарі надані</p>
                        </div>
                    </div>
                </div><!-- end col -->
            </div><!-- end row -->
...
<section class="get-started-area section--padding" id="for-sections">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title pb-3">Наш сайт для - Всіх!</h2>
            <p class="section-desc w-50 mx-auto">Просто виберіть розділ, який ви хочете дослідити, або розділ Запитання та відповіді, або розділ Треди
            </p>
        </div>
            ...
            <div class="col-lg-4-1 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Треди</h5>
                        <p class="card-text pb-4">Початкова ідея цього розділу покликана забезпечити простір для відкритого обговорення без очікування досягнення єдиної остаточної відповіді в 21 різній категорії</p>
                        <a href="/threads-home" class="btn theme-btn bg-3">Переглянути треди <i class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
...
<!-- ================================
       START CTA AREA
================================= -->
<section class="get-started-area section--padding bg-gray">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title pb-3">Для бізнесу, від забудовників</h2>
            <p class="section-desc w-50 mx-auto">Це лише простий текст, створений для цього унікального та чудового шаблону, ви можете замінити його будь-яким текстом.
            </p>
        </div>
        <div class="row pt-50px">
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a>Лемик Відповіді</a></h5>
                        <p>Взаємодіяйте з українською спільнотою через розділ «Запитання та відповіді», що дозволяє вільно обмінюватися знаннями та знаходити відповіді на ваші запитання</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a>Залучення громади</a></h5>
                        <p>Спілкуйтеся та співпрацюйте з українцями, зміцнюючи культурні та соціальні зв’язки в безпечному просторі форуму</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a>Виявлення вмісту</a></h5>
                        <p>Відкрийте для себе та пориньте в багаті, різноманітні дискусії, які формують і відображають український досвід та етос</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
...
<section class="info-area section--padding">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title pb-3">Переконайтеся, що ваша компанія залишається на курсі</h2>
            <p class="section-desc">Ось лише кілька типів технологів, яким ми допомагаємо.</p>
        </div>
        <div class="row pt-60px align-items-center">
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Лідери форуму</h5>
                    <p class="card-text">Керуйте розвитком платформи та створюйте дружнє середовище для всіх користувачів</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Культурні посли</h5>
                    <p class="card-text">Особи, які сприяють використанню української мови на платформі та допомагають підтримувати багате культурою та шанобливе онлайн-середовище</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center case-card-is-active">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Автори контенту</h5>
                    <p class="card-text">Діліться думками, досвідом і знаннями в українській спільноті</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Тільки українська мова</h5>
                    <p class="card-text">Це ідеальний час, щоб переїхати на українське, з такими однодумцями, як ти</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Шукачі знань</h5>
                    <p class="card-text">Ентузіасти, які навчаються, які використовують розділ «Запитання та відповіді» платформи, щоб ставити запитання, шукати поради та отримувати ідеї на основі спільного досвіду спільноти</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
        </div><!-- end row -->
    </div><!-- end container -->
...
<section class="get-started-area section--padding">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title">Вчись і розвивайся разом з Lemyk</h2>
        </div>
        <div class="row pt-50px">
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Беріть участь у динамічних дискусіях</h3>
                        <p>Зануртеся в різноманітні теми та створіть розповідь про майбутнє вашої спільноти, активно беручи участь у темах форуму.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Зробіть внесок у колективну мудрість</h3>
                        <p>Поділіться своїм досвідом або зверніться за порадою до нашого інклюзивного простору запитань і відповідей, де кожне запитання та відповідь збагачують наш спільний фонд знань.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Досліджуйте культурні ідеї</h3>
                        <p>Відкрийте для себе багатство української культури через спільні історії, досвід і дискусії, які перегукуються з вашою спадщиною та інтересами.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="info-box px-2">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Спілкуйтеся з однодумцями</h3>
                        <p>Знайдіть і спілкуйтеся з однолітками, які поділяють вашу пристрасть до важливих тем, сприяючи почуттю причетності та духу спільноти.</p>
                    </div>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->

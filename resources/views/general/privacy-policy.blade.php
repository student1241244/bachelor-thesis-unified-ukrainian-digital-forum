...
<section class="hero-area pattern-bg-2 bg-white shadow-sm overflow-hidden pt-50px pb-50px">
    ...
    <div class="container">
        <div class="hero-content text-center">
            <h2 class="section-title pb-3">Privacy Policy</h2>
            ...
            <div class="card-body row">
                <div class="col-lg-3">
                    <ul class="js-scroll-nav js--scroll-nav">
                        <li class="active"><a href="#information-we-collect-and-how-we-use-it" class="page-scroll">Privacy Policy</a></li>
                    </ul>
                </div><!-- end col-lg-3 -->
                <div class="col-lg-9">
                    <div class="terms-panel-main-bar pl-3">
                        <div class="terms-panel mb-30px" id="information-we-collect-and-how-we-use-it">
                            ...
                            <br>
                            <p>Last updated: December 24, 2023</p>
                            ...
                            <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Lemyk.</p>
                            </li>
                            <li>
                            ...
                            <li>
                            <p><strong>Website</strong> refers to Lemyk, accessible from <a href="https://lemyk.com" rel="external nofollow noopener" target="_blank">https://lemyk.com</a></p>
                            </li>
                            <li>
                            ...
                            <ul>
                            <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1f767179705f737a726674317c7072">[email&#160;protected]</a></li>

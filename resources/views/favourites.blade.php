        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="hero-content d-flex align-items-center">
                    ...
                    <h2 class="section-title fs-30">Favourites</h2>
                ...
                <div class="notification-content-wrap">
                    ...
                    <div class="media media-card media--card shadow-none rounded-0 align-items-center bg-transparent" style="display:block;">
                        ...
                        <div class="media-body p-0 border-left-0">
                            <h5 class="fs-14 fw-regular"><a href="/question-details/{{$favourite->id}}">{{$favourite->title}}</a></h5>
                    ...
                    <div class="media media-card media--card shadow-none rounded-0 align-items-center bg-transparent">
                        <p>No any Favourites Questions are saved yet.</p>
                    </div><!-- end media -->
                    @endunless

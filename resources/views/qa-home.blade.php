...
<section class="hero-area pt-80px pb-50px bg-white shadow-sm">
    ...
    <div class="container">
        ...
        <div class="hero-content text-center pb-3">
            <h2 class="section-title pb-3 fs-40">Спільнота соціальних запитань і відповідей</h2>
            <p class="section-desc">Розділ запитань і відповідей покликаний допомагати людям, допомагати один одному: <br>
                Запитувати, вчитися, ділитися, розвиватися.
            </p>
            <div class="hero-btn-box py-4">
                <a href="/ask-question" class="btn theme-btn mr-2">Задайте питання</a>
            </div>
        </div><!-- end hero-content -->
        <div class="hero-content text-center pb-5">
            <h2 class="section-title pb-3 fs-30">Виберіть категорію запитань і відповідей:</h2>
        </div>
        <div class="row">
            <div class="col-lg-4-2 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a href="/questions/1">Лемик Запитання</a></h5>
                        <p>Швидко задайте запитання та надайте відповідь, пов’язану із загальним типом запитів</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4-2 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a href="/questions/2">Лемик Програмісти</a></h5>
                        <p>Спеціально присвячений відповідям на запити програмістів</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4-2 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a href="/questions/3">Лемик Хакери</a></h5>
                        <p>Розділ охоплює широкий спектр запитань і відповідей щодо кібербезпеки, пов’язаних із захистом і нападом</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4-2 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a href="/questions/4">Лемик Навчання</a></h5>
                        <p>Розгляд запитань учнів та студентів</p>
                    </div>
                </div>
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
        <div class="row pt-50px">
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                ...
                <div class="media-body">
                    <h5 class="fs-18 mb-1 theme-font-2 fw-bold">Задайте питання</h5>
                    <p class="fs-15 lh-20">Отримайте правильні відповіді швидко.</p>
                </div>
            </div><!-- end media -->
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                ...
                <div class="media-body">
                    <h5 class="fs-18 mb-1 theme-font-2 fw-bold">Відповідати на запитання</h5>
                    <p class="fs-15 lh-20">Витратьте п’ять хвилин на почуття розуму.</p>
                </div>
            </div><!-- end media -->
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                ...
                <div class="media-body">
                    <h5 class="fs-18 mb-1 theme-font-2 fw-bold">Будь чиїмось героєм</h5>
                    <p class="fs-15 lh-20">Будь чиїмось героєм. Ти заслуговуєш на це.</p>
                </div>
            </div><!-- end media -->
        </div><!-- end hero-list -->
    </div><!-- end container -->

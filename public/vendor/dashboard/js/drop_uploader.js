        ...
        this.each(function(i, val) {
            ...
            function preview_file(file, i) {
                ...
                if(file.type.match('image/*')) {
                    ...
                    $('#' + uploader_id + ' #selected_file_' + i + ' div.thumbnail').html('<i class="fa file-video-o"></i>');
                } else if(file.type.match('audio/*')) {
                    $('#' + uploader_id + ' #selected_file_' + i + ' div.thumbnail').html('<i class="fa file-audio-o"></i>');
                } else {
                    $('#' + uploader_id + ' #selected_file_' + i + ' div.thumbnail').html('<i class="fa fa-file-o"></i>');
                }

                $('#uploadModal [data-apply]').attr('data-apply', 'on');
